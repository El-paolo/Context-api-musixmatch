...
const charts_tracks_get = "!chart.tracks.get?chart_name=top&page=1&page_size=5&country=it&f_has_lyrics=1";
...
export const chartsTracksGet = () => `${ cors_anywhere }${ base_url }${ charts_tracks_get }${ api_key }`;
